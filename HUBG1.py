...
def courbe(pourcent_chercher2,tiker_live,time1,time_name1,pourcent_chercher,pourcent_perdu,note,debugage,dejatoucher2,mirande3,mirande2,J,I,moyenne_tete,moins50p,local_min,local_max,A,B,C,D,E,F,G,df,place_liveprice):
    ...
    try:
        ...
        plt.text(mirande3['c'].iloc[0],  G + ((moyenne_tete) * 50 / 100), f"{round(G + ((moyenne_tete) * 50 / 100), 3)}", size=10.5, ha="center", va="center", bbox=dict(boxstyle="round", ec=(1., 0.5, 0.5), fc=(1., 0.8, 0.8), ))
        plt.text(mirande3['c'].iloc[0],  G - ((moyenne_tete) * 25 / 100), f"{round(G + ((moyenne_tete) * 50 / 100),3)}", size=10.5, ha="center", va="center", bbox=dict(boxstyle="round", ec=(1., 0.5, 0.5), fc=(1., 0.8, 0.8), ))
        plt.text(mirande3['c'].iloc[1], G + ((moyenne_tete) * 50 / 100), f"{round(J[1] + ((moyenne_tete) * 50 / 100), 3)} depuis G", size=10.5, ha="center", va="center", bbox=dict(boxstyle="round", ec="blue", fc="lightblue"))
        plt.text(mirande3['c'].iloc[1], G - ((moyenne_tete) * 25 / 100), f"{round(J[1] - ((moyenne_tete) * 25 / 100), 3)} depuis G", size=10.5, ha="center", va="center", bbox=dict(boxstyle="round", ec="blue", fc="lightblue"))
